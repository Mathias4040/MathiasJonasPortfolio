...
# --- THEME DESIGN SYSTEM (Acid Cyber Green) ---
BG = '#0D0E0D'
SURFACE = '#191B19'
TEXT = '#F0F5F0'
MUTED = '#8C948C'
...
def main(page: ft.Page):
    page.title = "Mathias Jonas - SiteSpy Portfolio"
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=ft.Column([
                    ...
                    ft.Text("Mathias Jonas", size=34, weight=ft.FontWeight.W_900, color=TEXT),
                    ft.Row([
                        ...
                        ft.Text("Mathiasjonas4040@gmail.com", color=MUTED, size=14, selectable=True),
                    ], wrap=True),
                    ft.Row([
                        ft.Icon(ft.Icons.LINK, size=15, color=ACCENT),
                        ft.Text("GitHub Profile: github.com/Mathias4040", color=ACCENT, size=14, selectable=True)
                    ], wrap=True),
                ], spacing=12)
            ),
    ...
    # Files list
    files_list = []
    for f in ['src/screens/ProjectDetailsScreen.js', 'src/screens/ProjectHistoryScreen.js', 'src/services/projectService.js']:
        files_list.append(
            ft.Container(
                padding=10,
                border_radius=6,
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=tile_card("My Project Focus", [
                    ft.Text("Project history and detail workflow.", size=14, color=TEXT),
            ...
            ft.Container(
                ...
                content=tile_card("Submission Information", [
                    ...
                    ft.Text('git config user.name "Mathias Jonas"\ngit config user.email "Mathiasjonas4040@gmail.com"', size=11, font_family="Consolas", color=TEXT, selectable=True),
                    ft.Divider(color=BORDER),
    ...
    footer = ft.Container(
        ...
        content=ft.Column([
            ft.Text("Mathias Jonas | SiteSpy Portfolio Showcase", color=TEXT, size=14, weight=ft.FontWeight.BOLD),
